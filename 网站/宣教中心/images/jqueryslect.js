...
(function($){
	...
	$.fn.styleSelect = function(options){
		...
		return this.each(function(){
			...
			//Options container
			var subContainer = $('<ul class="myslect"></ul>').css({'position' : 'absolute', 'z-index' : '100', 'top' : opts.optionsTop, 'left' : opts.optionsLeft})
			...
			mainSelect.find('option').each(function(){
				...
				optionsList += '>';
				optionsList += '<a href="'+$(this).val()+'" class="orig">';
